...
CREATE TABLE `loans` (
  ...
  `customer_code` varchar(40) DEFAULT NULL COMMENT '客户号',
  `account_num` varchar(20) DEFAULT NULL COMMENT '银行卡账号',
  `yearly_rate` float(10,4) default 0.0 COMMENT '年利率',
  `repayment_count` int(10) not null comment '',
  `due_date` Date not null COMMENT '应还日期',
  `loan_date` Date not null COMMENT '贷款日期',
  `loan_cost` float(20) not null COMMENT '贷款相关费用',
  `loan_amount` float(20) not null COMMENT '贷款费用',
...
(8,"L2104081553341","demo001202104079",'6161779470821245928',4.0000,2,'2021-06-07','2021-04-07',10.0000,9990.0000,"40001"),
(9,"L2104081553342","demo001202104079",'6161779470821245928',4.0000,3,'2021-04-07','2021-01-07',10.0000,19990.0000,"40001");
...
CREATE TABLE `repay_plans` (
  ...
  `plan_num` float(20) not null COMMENT '本次贷款的第几期',
  `plan_amount` float(20) not null,
  `plan_principal` float(20) default 0,
  `plan_interest` float(20) default 0,  
  `plan_date` date not null,
  `remain_amount` float(20) not null,
  `remain_principal` float(20) not null,
  `remain_interest` float(20) default 0,
  `fine` float(20) default 0 COMMENT '罚金',
...
(11,'L2104072048501','2021-04-07 20:53:27',1,5025.0114,4991.6814,33.3300,'2021-05-07',5025.0114,4991.6814,33.3300,0,'0'),
(12,'L2104072048501','2021-04-07 20:53:27',1,5025.0114,5008.3187,16.6927,'2021-06-07',5025.0114,5008.3187,16.6927,0,'0'),
(13,'L2104081553342','2021-01-07 20:53:27',1,6712.2785,6643.9385,68.3400,'2021-02-07',6712.2785,6643.9385,68.3400,0,'1'),
(14,'L2104081553342','2021-01-07 20:53:27',1,6712.2785,6666.6408,45.6377,'2021-03-07',6712.2785,6666.6408,45.6377,0,'1'),
(15,'L2104081553342','2021-01-07 20:53:27',1,6712.2785,6689.4207,22.8578,'2021-04-07',6712.2785,6689.4207,22.8578,0,'1');
